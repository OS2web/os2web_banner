...
/**
 * Provides a form for reverting a OS2Web Banner revision.
 *
...
class BannerRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'os2web_banner_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('OS2Web Banner: reverted %title revision %revision.', ['%title' => $this->revision->label(), '%revision' => $this->revision->getRevisionId()]);
    $this->messenger()->addMessage(t('OS2Web Banner %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\os2web_banner\Entity\BannerInterface $revision
